      ...
      <ul className="space-y-3">
        {["alice@example.com", "bob@example.com", "carol@example.com"].map(
          (email) => (
            ...
            >
              <span className="text-sm text-gray-800 dark:text-white">{email}</span>
              <button className="text-sm bg-green-500 hover:bg-green-600 text-white px-3 py-1 rounded-md transition-colors">
                Send
              </button>
            </li>
          )
